...
int16_t MPU6050_FIFO[6][11] = {0};//[0]-[9] [10]
int16_t HMC5883_FIFO[3][11] = {0};//[0]-[9] [10]
...
void MPU6050_DataSave(int16_t ax,int16_t ay,int16_t az,int16_t gx,int16_t gy,int16_t gz) //[0]-[9]
{
	uint8_t i = 0;
	int32_t sum=0;
...
void MPU6050_getMotion6(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz) {
	...
	if(isMPU6050_is_DRY)
	{
		...
		HMC58X3_ReadData(&(mpu_buf[14]));  //14-19
...
uint8_t HMC5883_Init(void)
{
    ...
    Delay_ms(5);
    IIC_WriteData(HMC5883_ADDRESS, HMC58X3_R_MODE,0x00);    //
...
void HMC58X3_ReadData(u8 *vbuff) {   
   MPU6050_ReadData(HMC5883_ADDRESS,HMC58X3_R_XM,vbuff,6);   //
}
